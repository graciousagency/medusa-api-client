...
class BasePaymentCollection extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The payment provider used to process the collection's payments and sessions.
     *
     * @return list<BasePaymentProvider>|null
     */
     ...
     * The payment provider used to process the collection's payments and sessions.
     *
     * @param list<BasePaymentProvider>|null $paymentProviders
     *
     * @return self
     */
     ...
     * The payment collection's payment sessions.
     *
     * @return list<BasePaymentSession>|null
     */
     ...
     * The payment collection's payment sessions.
     *
     * @param list<BasePaymentSession>|null $paymentSessions
     *
     * @return self
     */
