...
class AdminProductVariant extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AdminProductOptionValue>|null
     */
    protected $options;
    /**
     * 
     ...
     *
     * @var list<AdminProductVariantInventoryItemLink>|null
     */
     ...
     * The variant's prices.
     *
     * @param list<AdminPrice>|null $prices
     *
     * @return self
     */
     ...
     * The variant's option values.
     *
     * @return list<AdminProductOptionValue>|null
     */
     ...
     * The variant's option values.
     *
     * @param list<AdminProductOptionValue>|null $options
     *
     * @return self
     */
     ...
     * The variant's inventory items.
     *
     * @return list<AdminProductVariantInventoryItemLink>|null
     */
     ...
     * The variant's inventory items.
     *
     * @param list<AdminProductVariantInventoryItemLink>|null $inventoryItems
     *
     * @return self
     */
