...
class AdminInventoryItemsIdLocationLevelsGetResponse200 extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The inventory item's inventory levels.
     *
     * @param list<InventoryLevel>|null $inventoryLevels
     *
     * @return self
     */
    public function setInventoryLevels(?array $inventoryLevels): self
    {
        $this->initialized['inventoryLevels'] = true;
