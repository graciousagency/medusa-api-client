...
class AdminFulfillmentProviderOptionsListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AdminFulfillmentProviderOption>|null
     */
    protected $fulfillmentOptions;
    /**
     ...
     * The list of fulfillment options.
     *
     * @return list<AdminFulfillmentProviderOption>|null
     */
     ...
     * The list of fulfillment options.
     *
     * @param list<AdminFulfillmentProviderOption>|null $fulfillmentOptions
     *
     * @return self
     */
    public function setFulfillmentOptions(?array $fulfillmentOptions): self
    {
        $this->initialized['fulfillmentOptions'] = true;
