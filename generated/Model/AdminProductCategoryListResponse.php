...
class AdminProductCategoryListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The list of product categories.
     *
     * @param list<AdminProductCategory>|null $productCategories
     *
     * @return self
     */
    public function setProductCategories(?array $productCategories): self
    {
        $this->initialized['productCategories'] = true;
