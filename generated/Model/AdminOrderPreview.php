...
class AdminOrderPreview extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The order's items.
     *
     * @var list<AdminOrderPreviewItemsItem>|null
     */
    protected $items;
    /**
     * The order's shipping methods.
     *
     * @var list<AdminOrderPreviewShippingMethodsItem>|null
     */
     ...
     * The order's items.
     *
     * @return list<AdminOrderPreviewItemsItem>|null
     */
     ...
     * The order's items.
     *
     * @param list<AdminOrderPreviewItemsItem>|null $items
     *
     * @return self
     */
     ...
     * The order's shipping methods.
     *
     * @return list<AdminOrderPreviewShippingMethodsItem>|null
     */
     ...
     * The order's shipping methods.
     *
     * @param list<AdminOrderPreviewShippingMethodsItem>|null $shippingMethods
     *
     * @return self
     */
