...
class OrderChange extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<OrderChangeAction>|null
     */
    protected $actions;
    /**
     ...
     * @return array<string, mixed>|null
     */
    public function getReturnOrder(): ?iterable
    {
     ...
     * 
     *
     * @param array<string, mixed>|null $returnOrder
     *
     * @return self
     */
    public function setReturnOrder(?iterable $returnOrder): self
    {
     ...
     * The order change's exchange.
     *
     * @return OrderExchange|null
     */
    public function getExchange(): ?OrderExchange
    {
     ...
     * The order change's exchange.
     *
     * @param OrderExchange|null $exchange
     *
     * @return self
     */
    public function setExchange(?OrderExchange $exchange): self
    {
     ...
     * The order change's actions.
     *
     * @return list<OrderChangeAction>|null
     */
     ...
     * The order change's actions.
     *
     * @param list<OrderChangeAction>|null $actions
     *
     * @return self
     */
