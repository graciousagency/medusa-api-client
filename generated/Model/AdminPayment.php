...
class AdminPayment extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The details of payment refunds.
     *
     * @param list<AdminRefund>|null $refunds
     *
     * @return self
     */
     ...
     * The payment session's details.
     *
     * @return AdminPaymentSession|null
     */
    public function getPaymentSession(): ?AdminPaymentSession
    {
     ...
     * The payment session's details.
     *
     * @param AdminPaymentSession|null $paymentSession
     *
     * @return self
     */
    public function setPaymentSession(?AdminPaymentSession $paymentSession): self
    {
