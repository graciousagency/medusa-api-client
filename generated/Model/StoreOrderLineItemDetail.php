...
class StoreOrderLineItemDetail extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The detail's item.
     *
     * @var StoreOrderLineItemDetailitem|null
     */
    protected $item;
    /**
     * The item's quantity.
     ...
     * The detail's item.
     *
     * @return StoreOrderLineItemDetailitem|null
     */
    public function getItem(): ?StoreOrderLineItemDetailitem
    {
        return $this->item;
    }
    /**
     * The detail's item.
     *
     * @param StoreOrderLineItemDetailitem|null $item
     *
     * @return self
     */
    public function setItem(?StoreOrderLineItemDetailitem $item): self
    {
