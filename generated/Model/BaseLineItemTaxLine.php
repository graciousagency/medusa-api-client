...
class BaseLineItemTaxLine extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The tax line's item.
     *
     * @return BaseCartLineItem|null
     */
    public function getItem(): ?BaseCartLineItem
    {
        return $this->item;
    }
    /**
     * The tax line's item.
     *
     * @param BaseCartLineItem|null $item
     *
     * @return self
     */
    public function setItem(?BaseCartLineItem $item): self
    {
