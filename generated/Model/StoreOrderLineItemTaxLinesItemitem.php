...
class StoreOrderLineItemTaxLinesItemitem extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The item's variant.
     *
     * @var StoreOrderLineItemTaxLinesItemitemVariant|null
     */
    protected $variant;
    /**
     * The item's product.
     *
     * @var StoreOrderLineItemTaxLinesItemitemProduct|null
     */
    protected $product;
    /**
     * The item's tax lines.
     *
     * @var list<StoreOrderLineItemTaxLinesItemitemTaxLinesItem>|null
     */
    protected $taxLines;
    /**
     * The item's adjustments.
     *
     * @var list<StoreOrderLineItemTaxLinesItemitemAdjustmentsItem>|null
     */
    protected $adjustments;
    /**
     * 
     *
     * @var StoreOrderLineItemTaxLinesItemitemDetail|null
     */
    protected $detail;
    /**
     * The item's title.
     ...
     * The item's variant.
     *
     * @return StoreOrderLineItemTaxLinesItemitemVariant|null
     */
    public function getVariant(): ?StoreOrderLineItemTaxLinesItemitemVariant
    {
        return $this->variant;
    }
    /**
     * The item's variant.
     *
     * @param StoreOrderLineItemTaxLinesItemitemVariant|null $variant
     *
     * @return self
     */
    public function setVariant(?StoreOrderLineItemTaxLinesItemitemVariant $variant): self
    {
     ...
     * The item's product.
     *
     * @return StoreOrderLineItemTaxLinesItemitemProduct|null
     */
    public function getProduct(): ?StoreOrderLineItemTaxLinesItemitemProduct
    {
        return $this->product;
    }
    /**
     * The item's product.
     *
     * @param StoreOrderLineItemTaxLinesItemitemProduct|null $product
     *
     * @return self
     */
    public function setProduct(?StoreOrderLineItemTaxLinesItemitemProduct $product): self
    {
     ...
     * The item's tax lines.
     *
     * @return list<StoreOrderLineItemTaxLinesItemitemTaxLinesItem>|null
     */
     ...
     * The item's tax lines.
     *
     * @param list<StoreOrderLineItemTaxLinesItemitemTaxLinesItem>|null $taxLines
     *
     * @return self
     */
     ...
     * The item's adjustments.
     *
     * @return list<StoreOrderLineItemTaxLinesItemitemAdjustmentsItem>|null
     */
     ...
     * The item's adjustments.
     *
     * @param list<StoreOrderLineItemTaxLinesItemitemAdjustmentsItem>|null $adjustments
     *
     * @return self
     */
     ...
     * 
     *
     * @return StoreOrderLineItemTaxLinesItemitemDetail|null
     */
    public function getDetail(): ?StoreOrderLineItemTaxLinesItemitemDetail
    {
        return $this->detail;
    }
    /**
     * 
     *
     * @param StoreOrderLineItemTaxLinesItemitemDetail|null $detail
     *
     * @return self
     */
    public function setDetail(?StoreOrderLineItemTaxLinesItemitemDetail $detail): self
    {
