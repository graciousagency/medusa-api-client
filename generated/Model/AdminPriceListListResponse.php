...
class AdminPriceListListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The list of price lists.
     *
     * @return list<AdminPriceList>|null
     */
     ...
     * The list of price lists.
     *
     * @param list<AdminPriceList>|null $priceLists
     *
     * @return self
     */
    public function setPriceLists(?array $priceLists): self
    {
        $this->initialized['priceLists'] = true;
