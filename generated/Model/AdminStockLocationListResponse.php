...
class AdminStockLocationListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     *
     * @var list<AdminStockLocation>|null
     */
     ...
     * The list of stock locations.
     *
     * @return list<AdminStockLocation>|null
     */
     ...
     * The list of stock locations.
     *
     * @param list<AdminStockLocation>|null $stockLocations
     *
     * @return self
     */
    public function setStockLocations(?array $stockLocations): self
    {
        $this->initialized['stockLocations'] = true;
