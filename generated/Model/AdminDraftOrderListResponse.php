...
class AdminDraftOrderListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The list of draft orders.
     *
     * @return list<AdminDraftOrder>|null
     */
    public function getDraftOrders(): ?array
    {
     ...
     * The list of draft orders.
     *
     * @param list<AdminDraftOrder>|null $draftOrders
     *
     * @return self
     */
    public function setDraftOrders(?array $draftOrders): self
    {
        $this->initialized['draftOrders'] = true;
