...
class AdminStoreListResponse extends \ArrayObject
{
    /**
     * @var array
     */
     ...
     * The list of stores.
     *
     * @param list<AdminStore>|null $stores
     *
     * @return self
     */
    public function setStores(?array $stores): self
    {
        $this->initialized['stores'] = true;
        $this->stores = $stores;
        return $this;
    }
    /**
