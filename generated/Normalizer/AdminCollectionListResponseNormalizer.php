...
class AdminCollectionListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminCollectionListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminCollectionListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminCollectionListResponse();
        ...
        if (\array_key_exists('collections', $data) && $data['collections'] !== null) {
            $values = [];
            foreach ($data['collections'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminCollection::class, 'json', $context);
            }
            $object->setCollections($values);
            unset($data['collections']);
        }
        elseif (\array_key_exists('collections', $data) && $data['collections'] === null) {
            $object->setCollections(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getCollections() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['collections'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminCollectionListResponse::class => false];
    }
}