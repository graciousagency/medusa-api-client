...
class StoreProductCategoryListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreProductCategoryListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreProductCategoryListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreProductCategoryListResponse();
        ...
        if (\array_key_exists('product_categories', $data) && $data['product_categories'] !== null) {
            $values = [];
            foreach ($data['product_categories'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreProductCategory::class, 'json', $context);
            }
            $object->setProductCategories($values);
            unset($data['product_categories']);
        }
        elseif (\array_key_exists('product_categories', $data) && $data['product_categories'] === null) {
            $object->setProductCategories(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getProductCategories() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['product_categories'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreProductCategoryListResponse::class => false];
    }
}