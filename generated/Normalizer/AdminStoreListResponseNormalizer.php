...
class AdminStoreListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminStoreListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminStoreListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminStoreListResponse();
        ...
        if (\array_key_exists('stores', $data) && $data['stores'] !== null) {
            $values = [];
            foreach ($data['stores'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminStore::class, 'json', $context);
            }
            $object->setStores($values);
            unset($data['stores']);
        }
        elseif (\array_key_exists('stores', $data) && $data['stores'] === null) {
            $object->setStores(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getStores() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['stores'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminStoreListResponse::class => false];
    }
}