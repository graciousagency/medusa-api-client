...
class AdminOrderLineItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem();
        ...
        if (\array_key_exists('variant', $data) && $data['variant'] !== null) {
            $object->setVariant($this->denormalizer->denormalize($data['variant'], \Gracious\MedusaApiClientBundle\Model\AdminProductVariant::class, 'json', $context));
            unset($data['variant']);
        }
        ...
        if (\array_key_exists('product', $data) && $data['product'] !== null) {
            $object->setProduct($this->denormalizer->denormalize($data['product'], \Gracious\MedusaApiClientBundle\Model\AdminProduct::class, 'json', $context));
            unset($data['product']);
        }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            ...
            foreach ($data['detail'] as $key_1 => $value_3) {
                $values_3[$key_1] = $value_3;
            }
            $object->setDetail($values_3);
            unset($data['detail']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values_3 = [];
        foreach ($data->getDetail() as $key_1 => $value_3) {
            $values_3[$key_1] = $value_3;
        }
        $dataArray['detail'] = $values_3;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem::class => false];
    }
}
