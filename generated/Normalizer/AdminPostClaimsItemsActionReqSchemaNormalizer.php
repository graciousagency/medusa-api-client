...
class AdminPostClaimsItemsActionReqSchemaNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPostClaimsItemsActionReqSchema::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPostClaimsItemsActionReqSchema::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPostClaimsItemsActionReqSchema();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPostClaimsItemsActionReqSchema::class => false];
    }
}