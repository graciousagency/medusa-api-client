...
class StoreOrderShippingMethodAdjustmentsItemshippingMethodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethod::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethod::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethod();
        ...
        if (\array_key_exists('tax_lines', $data) && $data['tax_lines'] !== null) {
            ...
            foreach ($data['tax_lines'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethodTaxLinesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethodAdjustmentsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethodDetail::class, 'json', $context));
            unset($data['detail']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItemshippingMethod::class => false];
    }
}
