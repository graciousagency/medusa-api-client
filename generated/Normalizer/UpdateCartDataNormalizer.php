...
class UpdateCartDataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\UpdateCartData::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\UpdateCartData::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\UpdateCartData();
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('shippingAddressId') && null !== $data->getShippingAddressId()) {
            $dataArray['shipping_address_id'] = $data->getShippingAddressId();
        }
        if ($data->isInitialized('billingAddressId') && null !== $data->getBillingAddressId()) {
            $dataArray['billing_address_id'] = $data->getBillingAddressId();
        }
        if ($data->isInitialized('billingAddress') && null !== $data->getBillingAddress()) {
            $dataArray['billing_address'] = $data->getBillingAddress();
        }
        if ($data->isInitialized('shippingAddress') && null !== $data->getShippingAddress()) {
            $dataArray['shipping_address'] = $data->getShippingAddress();
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\UpdateCartData::class => false];
    }
}