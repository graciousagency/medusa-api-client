...
class StoreOrderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrder::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrder::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrder();
        ...
        if (\array_key_exists('shipping_address', $data) && $data['shipping_address'] !== null) {
            $object->setShippingAddress($this->denormalizer->denormalize($data['shipping_address'], \Gracious\MedusaApiClientBundle\Model\StoreOrderAddress::class, 'json', $context));
        ...
        if (\array_key_exists('billing_address', $data) && $data['billing_address'] !== null) {
            $object->setBillingAddress($this->denormalizer->denormalize($data['billing_address'], \Gracious\MedusaApiClientBundle\Model\StoreOrderAddress::class, 'json', $context));
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('shipping_methods', $data) && $data['shipping_methods'] !== null) {
            ...
            foreach ($data['shipping_methods'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethod::class, 'json', $context);
            }
        ...
        if (\array_key_exists('payment_collections', $data) && $data['payment_collections'] !== null) {
            ...
            foreach ($data['payment_collections'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\StorePaymentCollection::class, 'json', $context);
            }
        ...
        if (\array_key_exists('fulfillments', $data) && $data['fulfillments'] !== null) {
            ...
            foreach ($data['fulfillments'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\StoreOrderFulfillment::class, 'json', $context);
            }
        ...
        if (\array_key_exists('transactions', $data) && $data['transactions'] !== null) {
            $values_5 = [];
            foreach ($data['transactions'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \Gracious\MedusaApiClientBundle\Model\BaseOrderTransaction::class, 'json', $context);
            }
            $object->setTransactions($values_5);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('paymentCollections') && null !== $data->getPaymentCollections()) {
            $values_2 = [];
        ...
        if ($data->isInitialized('transactions') && null !== $data->getTransactions()) {
            $values_5 = [];
            foreach ($data->getTransactions() as $value_5) {
                $values_5[] = $this->normalizer->normalize($value_5, 'json', $context);
            }
            $dataArray['transactions'] = $values_5;
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrder::class => false];
    }
}
