...
class AdminDraftOrderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrder::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrder::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminDraftOrder();
        ...
        if (\array_key_exists('payment_collections', $data) && $data['payment_collections'] !== null) {
            ...
            foreach ($data['payment_collections'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminPaymentCollection::class, 'json', $context);
            }
        ...
        if (\array_key_exists('fulfillments', $data) && $data['fulfillments'] !== null) {
            ...
            foreach ($data['fulfillments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminOrderFulfillment::class, 'json', $context);
            }
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('shipping_methods', $data) && $data['shipping_methods'] !== null) {
            ...
            foreach ($data['shipping_methods'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\AdminOrderShippingMethod::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminDraftOrder::class => false];
    }
}
