...
class AdminOrderAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminOrderAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminOrderAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminOrderAddress();
        ...
        if (\array_key_exists('country', $data) && $data['country'] !== null) {
            $object->setCountry($this->denormalizer->denormalize($data['country'], \Gracious\MedusaApiClientBundle\Model\AdminRegionCountry::class, 'json', $context));
            unset($data['country']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminOrderAddress::class => false];
    }
}
