...
class AdminProductsIdVariantsVariantIdPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsVariantIdPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsVariantIdPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsVariantIdPostBody();
        ...
        if (\array_key_exists('additional_data', $data) && $data['additional_data'] !== null) {
            ...
            foreach ($data['additional_data'] as $key_2 => $value_3) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('additionalData') && null !== $data->getAdditionalData()) {
            $values_3 = [];
            foreach ($data->getAdditionalData() as $key_2 => $value_3) {
                $values_3[$key_2] = $value_3;
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsVariantIdPostBody::class => false];
    }
}