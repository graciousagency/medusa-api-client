...
class AdminPricePreferenceListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPricePreferenceListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPricePreferenceListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPricePreferenceListResponse();
        ...
        if (\array_key_exists('price_preferences', $data) && $data['price_preferences'] !== null) {
            $values = [];
            foreach ($data['price_preferences'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminPricePreference::class, 'json', $context);
            }
            $object->setPricePreferences($values);
            unset($data['price_preferences']);
        }
        elseif (\array_key_exists('price_preferences', $data) && $data['price_preferences'] === null) {
            $object->setPricePreferences(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getPricePreferences() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['price_preferences'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPricePreferenceListResponse::class => false];
    }
}