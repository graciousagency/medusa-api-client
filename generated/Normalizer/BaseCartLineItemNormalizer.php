...
class BaseCartLineItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\BaseCartLineItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\BaseCartLineItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\BaseCartLineItem();
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\BaseLineItemAdjustment::class, 'json', $context);
            }
        ...
        if (\array_key_exists('cart', $data) && $data['cart'] !== null) {
            $object->setCart($this->denormalizer->denormalize($data['cart'], \Gracious\MedusaApiClientBundle\Model\BaseCart::class, 'json', $context));
            unset($data['cart']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['cart'] = $this->normalizer->normalize($data->getCart(), 'json', $context);
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\BaseCartLineItem::class => false];
    }
}
