...
class AdminStockLocationListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminStockLocationListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminStockLocationListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminStockLocationListResponse();
        ...
        if (\array_key_exists('stock_locations', $data) && $data['stock_locations'] !== null) {
            $values = [];
            foreach ($data['stock_locations'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminStockLocation::class, 'json', $context);
            }
            $object->setStockLocations($values);
            unset($data['stock_locations']);
        }
        elseif (\array_key_exists('stock_locations', $data) && $data['stock_locations'] === null) {
            $object->setStockLocations(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getStockLocations() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['stock_locations'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminStockLocationListResponse::class => false];
    }
}