...
class AdminFulfillmentProviderListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentProviderListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentProviderListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentProviderListResponse();
        ...
        if (\array_key_exists('fulfillment_providers', $data) && $data['fulfillment_providers'] !== null) {
            $values = [];
            foreach ($data['fulfillment_providers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentProvider::class, 'json', $context);
            }
            $object->setFulfillmentProviders($values);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getFulfillmentProviders() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['fulfillment_providers'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminFulfillmentProviderListResponse::class => false];
    }
}