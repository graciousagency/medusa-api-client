...
class AdminReturnReasonListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminReturnReasonListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminReturnReasonListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminReturnReasonListResponse();
        ...
        if (\array_key_exists('return_reasons', $data) && $data['return_reasons'] !== null) {
            $values = [];
            foreach ($data['return_reasons'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminReturnReason::class, 'json', $context);
            }
            $object->setReturnReasons($values);
            unset($data['return_reasons']);
        }
        elseif (\array_key_exists('return_reasons', $data) && $data['return_reasons'] === null) {
            $object->setReturnReasons(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getReturnReasons() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['return_reasons'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminReturnReasonListResponse::class => false];
    }
}