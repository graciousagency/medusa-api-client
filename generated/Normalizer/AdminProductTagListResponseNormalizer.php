...
class AdminProductTagListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminProductTagListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminProductTagListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminProductTagListResponse();
        ...
        if (\array_key_exists('product_tags', $data) && $data['product_tags'] !== null) {
            $values = [];
            foreach ($data['product_tags'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminProductTag::class, 'json', $context);
            }
            $object->setProductTags($values);
            unset($data['product_tags']);
        }
        elseif (\array_key_exists('product_tags', $data) && $data['product_tags'] === null) {
            $object->setProductTags(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getProductTags() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['product_tags'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminProductTagListResponse::class => false];
    }
}