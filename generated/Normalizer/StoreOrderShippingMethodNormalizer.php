...
class StoreOrderShippingMethodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethod::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethod::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethod();
        ...
        if (\array_key_exists('tax_lines', $data) && $data['tax_lines'] !== null) {
            ...
            foreach ($data['tax_lines'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodAdjustmentsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodDetail::class, 'json', $context));
            unset($data['detail']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethod::class => false];
    }
}
