...
class StoreOrderLineItemDetailitemTaxLinesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemTaxLinesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemTaxLinesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemTaxLinesItem();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemTaxLinesItem::class => false];
    }
}
