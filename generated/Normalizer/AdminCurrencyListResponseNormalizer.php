...
class AdminCurrencyListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminCurrencyListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminCurrencyListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminCurrencyListResponse();
        ...
        if (\array_key_exists('currencies', $data) && $data['currencies'] !== null) {
            $values = [];
            foreach ($data['currencies'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminCurrency::class, 'json', $context);
            }
            $object->setCurrencies($values);
            unset($data['currencies']);
        }
        elseif (\array_key_exists('currencies', $data) && $data['currencies'] === null) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getCurrencies() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['currencies'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminCurrencyListResponse::class => false];
    }
}