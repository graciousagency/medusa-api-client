...
class StoreOrderLineItemTaxLinesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemTaxLinesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemTaxLinesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemTaxLinesItem();
        ...
        if (\array_key_exists('item', $data) && $data['item'] !== null) {
            $object->setItem($this->denormalizer->denormalize($data['item'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemTaxLinesItemitem::class, 'json', $context));
            unset($data['item']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemTaxLinesItem::class => false];
    }
}
