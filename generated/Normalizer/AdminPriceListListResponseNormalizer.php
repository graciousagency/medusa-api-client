...
class AdminPriceListListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPriceListListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPriceListListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPriceListListResponse();
        ...
        if (\array_key_exists('price_lists', $data) && $data['price_lists'] !== null) {
            $values = [];
            foreach ($data['price_lists'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminPriceList::class, 'json', $context);
            }
            $object->setPriceLists($values);
            unset($data['price_lists']);
        }
        elseif (\array_key_exists('price_lists', $data) && $data['price_lists'] === null) {
            $object->setPriceLists(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getPriceLists() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['price_lists'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPriceListListResponse::class => false];
    }
}