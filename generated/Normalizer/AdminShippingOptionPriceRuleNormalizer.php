...
class AdminShippingOptionPriceRuleNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminShippingOptionPriceRule::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminShippingOptionPriceRule::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminShippingOptionPriceRule();
        ...
        if (\array_key_exists('price_id', $data) && $data['price_id'] !== null) {
            $object->setPriceId($data['price_id']);
            unset($data['price_id']);
        }
        elseif (\array_key_exists('price_id', $data) && $data['price_id'] === null) {
            $object->setPriceId(null);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminShippingOptionPriceRule::class => false];
    }
}
