...
class StoreProductTypeListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreProductTypeListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreProductTypeListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreProductTypeListResponse();
        ...
        if (\array_key_exists('product_types', $data) && $data['product_types'] !== null) {
            $values = [];
            foreach ($data['product_types'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreProductType::class, 'json', $context);
            }
            $object->setProductTypes($values);
            unset($data['product_types']);
        }
        elseif (\array_key_exists('product_types', $data) && $data['product_types'] === null) {
            $object->setProductTypes(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getProductTypes() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['product_types'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreProductTypeListResponse::class => false];
    }
}