...
class AdminPriceNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPrice::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPrice::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPrice();
        ...
        if (\array_key_exists('raw_amount', $data) && $data['raw_amount'] !== null) {
            ...
            foreach ($data['raw_amount'] as $key => $value) {
                $values[$key] = $value;
            }
            $object->setRawAmount($values);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getRawAmount() as $key => $value) {
            $values[$key] = $value;
        }
        $dataArray['raw_amount'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPrice::class => false];
    }
}
