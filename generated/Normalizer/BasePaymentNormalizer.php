...
class BasePaymentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\BasePayment::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\BasePayment::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\BasePayment();
        ...
        if (\array_key_exists('refunds', $data) && $data['refunds'] !== null) {
            ...
            foreach ($data['refunds'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\BaseRefund::class, 'json', $context);
            }
        ...
        if (\array_key_exists('payment_session', $data) && $data['payment_session'] !== null) {
            ...
            foreach ($data['payment_session'] as $key_2 => $value_4) {
                $values_4[$key_2] = $value_4;
            }
            $object->setPaymentSession($values_4);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('paymentSession') && null !== $data->getPaymentSession()) {
            $values_4 = [];
            foreach ($data->getPaymentSession() as $key_2 => $value_4) {
                $values_4[$key_2] = $value_4;
            }
            $dataArray['payment_session'] = $values_4;
        }
        foreach ($data as $key_3 => $value_5) {
            if (preg_match('/.*/', (string) $key_3)) {
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\BasePayment::class => false];
    }
}
