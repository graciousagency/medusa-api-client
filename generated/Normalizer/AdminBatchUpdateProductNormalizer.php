...
class AdminBatchUpdateProductNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProduct::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProduct::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProduct();
        ...
        if (\array_key_exists('images', $data) && $data['images'] !== null) {
            ...
            foreach ($data['images'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProductImagesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('categories', $data) && $data['categories'] !== null) {
            ...
            foreach ($data['categories'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProductCategoriesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('tags', $data) && $data['tags'] !== null) {
            ...
            foreach ($data['tags'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProductTagsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data) && $data['options'] !== null) {
            ...
            foreach ($data['options'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\AdminUpdateProductOption::class, 'json', $context);
            }
        ...
        if (\array_key_exists('sales_channels', $data) && $data['sales_channels'] !== null) {
            ...
            foreach ($data['sales_channels'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, \Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProductSalesChannelsItem::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminBatchUpdateProduct::class => false];
    }
}