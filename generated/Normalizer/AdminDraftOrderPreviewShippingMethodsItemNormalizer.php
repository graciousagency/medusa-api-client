...
class AdminDraftOrderPreviewShippingMethodsItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderPreviewShippingMethodsItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderPreviewShippingMethodsItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderPreviewShippingMethodsItem();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminDraftOrderPreviewShippingMethodsItem::class => false];
    }
}
