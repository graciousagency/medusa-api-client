...
class AdminPromotionsIdTargetRulesBatchPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPromotionsIdTargetRulesBatchPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPromotionsIdTargetRulesBatchPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPromotionsIdTargetRulesBatchPostBody();
        ...
        if (\array_key_exists('create', $data) && $data['create'] !== null) {
            ...
            foreach ($data['create'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminCreatePromotionRule::class, 'json', $context);
            }
        ...
        if (\array_key_exists('update', $data) && $data['update'] !== null) {
            ...
            foreach ($data['update'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminUpdatePromotionRule::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPromotionsIdTargetRulesBatchPostBody::class => false];
    }
}