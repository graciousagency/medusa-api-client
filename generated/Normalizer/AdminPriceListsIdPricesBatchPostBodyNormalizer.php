...
class AdminPriceListsIdPricesBatchPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBody();
        ...
        if (\array_key_exists('create', $data) && $data['create'] !== null) {
            ...
            foreach ($data['create'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBodyCreateItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('update', $data) && $data['update'] !== null) {
            ...
            foreach ($data['update'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBodyUpdateItem::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminPriceListsIdPricesBatchPostBody::class => false];
    }
}