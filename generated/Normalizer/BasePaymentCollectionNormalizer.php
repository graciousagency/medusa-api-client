...
class BasePaymentCollectionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\BasePaymentCollection::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\BasePaymentCollection::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\BasePaymentCollection();
        ...
        if (\array_key_exists('payment_providers', $data) && $data['payment_providers'] !== null) {
            ...
            foreach ($data['payment_providers'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\BasePaymentProvider::class, 'json', $context);
            }
        ...
        if (\array_key_exists('payment_sessions', $data) && $data['payment_sessions'] !== null) {
            ...
            foreach ($data['payment_sessions'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\BasePaymentSession::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\BasePaymentCollection::class => false];
    }
}
