...
class AdminOrderShippingMethodNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminOrderShippingMethod::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminOrderShippingMethod::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminOrderShippingMethod();
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\BaseOrderShippingDetail::class, 'json', $context));
            unset($data['detail']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminOrderShippingMethod::class => false];
    }
}
