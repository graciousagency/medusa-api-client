...
class AdminProductsIdVariantsPostBodyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsPostBody::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsPostBody::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsPostBody();
        ...
        if (\array_key_exists('inventory_items', $data) && $data['inventory_items'] !== null) {
            $values_3 = [];
            foreach ($data['inventory_items'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\AdminCreateProductVariantInventoryKit::class, 'json', $context);
            }
            $object->setInventoryItems($values_3);
        ...
        if (\array_key_exists('additional_data', $data) && $data['additional_data'] !== null) {
            ...
            foreach ($data['additional_data'] as $key_2 => $value_4) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('inventoryItems') && null !== $data->getInventoryItems()) {
            $values_3 = [];
            foreach ($data->getInventoryItems() as $value_3) {
                $values_3[] = $this->normalizer->normalize($value_3, 'json', $context);
            }
            $dataArray['inventory_items'] = $values_3;
        }
        if ($data->isInitialized('additionalData') && null !== $data->getAdditionalData()) {
            $values_4 = [];
            foreach ($data->getAdditionalData() as $key_2 => $value_4) {
                $values_4[$key_2] = $value_4;
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminProductsIdVariantsPostBody::class => false];
    }
}