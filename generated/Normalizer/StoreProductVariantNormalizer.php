...
class StoreProductVariantNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreProductVariant::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreProductVariant::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreProductVariant();
        ...
        if (\array_key_exists('options', $data) && $data['options'] !== null) {
            ...
            foreach ($data['options'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreProductOptionValue::class, 'json', $context);
            }
        ...
        if (\array_key_exists('product', $data) && $data['product'] !== null) {
            ...
            foreach ($data['product'] as $key => $value_1) {
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('product') && null !== $data->getProduct()) {
            $values_1 = [];
            foreach ($data->getProduct() as $key => $value_1) {
                $values_1[$key] = $value_1;
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreProductVariant::class => false];
    }
}
