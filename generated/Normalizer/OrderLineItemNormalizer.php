...
class OrderLineItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\OrderLineItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\OrderLineItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\OrderLineItem();
        ...
        if (\array_key_exists('tax_lines', $data) && $data['tax_lines'] !== null) {
            ...
            foreach ($data['tax_lines'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\OrderLineItemTaxLine::class, 'json', $context);
            }
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\OrderLineItemAdjustment::class, 'json', $context);
            }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\OrderItem::class, 'json', $context));
            unset($data['detail']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('productTypeId') && null !== $data->getProductTypeId()) {
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\OrderLineItem::class => false];
    }
}
