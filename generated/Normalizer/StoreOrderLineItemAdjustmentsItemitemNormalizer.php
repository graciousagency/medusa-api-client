...
class StoreOrderLineItemAdjustmentsItemitemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitem();
        ...
        if (\array_key_exists('variant', $data) && $data['variant'] !== null) {
            $object->setVariant($this->denormalizer->denormalize($data['variant'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitemVariant::class, 'json', $context));
            unset($data['variant']);
        }
        ...
        if (\array_key_exists('product', $data) && $data['product'] !== null) {
            $object->setProduct($this->denormalizer->denormalize($data['product'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitemProduct::class, 'json', $context));
            unset($data['product']);
        }
        ...
        if (\array_key_exists('tax_lines', $data) && $data['tax_lines'] !== null) {
            ...
            foreach ($data['tax_lines'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitemTaxLinesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitemAdjustmentsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitemDetail::class, 'json', $context));
            unset($data['detail']);
        }
        ...
        if (\array_key_exists('variant_option_values', $data) && $data['variant_option_values'] !== null) {
            ...
            foreach ($data['variant_option_values'] as $key_1 => $value_3) {
                $values_3[$key_1] = $value_3;
            }
            $object->setVariantOptionValues($values_3);
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values_3 = [];
        foreach ($data->getVariantOptionValues() as $key_1 => $value_3) {
            $values_3[$key_1] = $value_3;
        }
        $dataArray['variant_option_values'] = $values_3;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemAdjustmentsItemitem::class => false];
    }
}
