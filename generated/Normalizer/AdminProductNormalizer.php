...
class AdminProductNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminProduct::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminProduct::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminProduct();
        ...
        if (\array_key_exists('collection', $data) && $data['collection'] !== null) {
            $object->setCollection($this->denormalizer->denormalize($data['collection'], \Gracious\MedusaApiClientBundle\Model\AdminCollection::class, 'json', $context));
        ...
        if (\array_key_exists('sales_channels', $data) && $data['sales_channels'] !== null) {
            $values_1 = [];
            foreach ($data['sales_channels'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminSalesChannel::class, 'json', $context);
            }
        ...
        if (\array_key_exists('variants', $data) && $data['variants'] !== null) {
            ...
            foreach ($data['variants'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\AdminProductVariant::class, 'json', $context);
            }
        ...
        if (\array_key_exists('type', $data) && $data['type'] !== null) {
            $object->setType($this->denormalizer->denormalize($data['type'], \Gracious\MedusaApiClientBundle\Model\AdminProductType::class, 'json', $context));
            unset($data['type']);
        }
        ...
        if (\array_key_exists('tags', $data) && $data['tags'] !== null) {
            ...
            foreach ($data['tags'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\AdminProductTag::class, 'json', $context);
            }
        ...
        if (\array_key_exists('options', $data) && $data['options'] !== null) {
            ...
            foreach ($data['options'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \Gracious\MedusaApiClientBundle\Model\AdminProductOption::class, 'json', $context);
            }
        ...
        if (\array_key_exists('images', $data) && $data['images'] !== null) {
            ...
            foreach ($data['images'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, \Gracious\MedusaApiClientBundle\Model\AdminProductImage::class, 'json', $context);
            }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('salesChannels') && null !== $data->getSalesChannels()) {
            ...
            $dataArray['sales_channels'] = $values_1;
        }
        $values_2 = [];
        ...
        if ($data->isInitialized('shippingProfile') && null !== $data->getShippingProfile()) {
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminProduct::class => false];
    }
}
