...
class OrderTransactionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\OrderTransaction::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\OrderTransaction::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\OrderTransaction();
        ...
        if (\array_key_exists('order', $data) && $data['order'] !== null) {
            ...
            foreach ($data['order'] as $key_1 => $value_1) {
                $values_1[$key_1] = $value_1;
            }
            $object->setOrder($values_1);
            unset($data['order']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values_1 = [];
        foreach ($data->getOrder() as $key_1 => $value_1) {
            $values_1[$key_1] = $value_1;
        }
        $dataArray['order'] = $values_1;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\OrderTransaction::class => false];
    }
}
