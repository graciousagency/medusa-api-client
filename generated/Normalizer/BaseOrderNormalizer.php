...
class BaseOrderNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\BaseOrder::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\BaseOrder::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\BaseOrder();
        ...
        if (\array_key_exists('payment_collections', $data) && $data['payment_collections'] !== null) {
            $values = [];
            foreach ($data['payment_collections'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\BasePaymentCollection::class, 'json', $context);
            }
            $object->setPaymentCollections($values);
        ...
        if (\array_key_exists('fulfillments', $data) && $data['fulfillments'] !== null) {
            $values_1 = [];
            foreach ($data['fulfillments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\BaseOrderFulfillment::class, 'json', $context);
            }
            $object->setFulfillments($values_1);
        ...
        if (\array_key_exists('shipping_address', $data) && $data['shipping_address'] !== null) {
            $object->setShippingAddress($this->denormalizer->denormalize($data['shipping_address'], \Gracious\MedusaApiClientBundle\Model\BaseOrderAddress::class, 'json', $context));
        ...
        if (\array_key_exists('billing_address', $data) && $data['billing_address'] !== null) {
            $object->setBillingAddress($this->denormalizer->denormalize($data['billing_address'], \Gracious\MedusaApiClientBundle\Model\BaseOrderAddress::class, 'json', $context));
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, \Gracious\MedusaApiClientBundle\Model\BaseOrderLineItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('shipping_methods', $data) && $data['shipping_methods'] !== null) {
            ...
            foreach ($data['shipping_methods'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, \Gracious\MedusaApiClientBundle\Model\BaseOrderShippingMethod::class, 'json', $context);
            }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('paymentCollections') && null !== $data->getPaymentCollections()) {
            $values = [];
            foreach ($data->getPaymentCollections() as $value) {
                $values[] = $this->normalizer->normalize($value, 'json', $context);
            }
            $dataArray['payment_collections'] = $values;
        }
        if ($data->isInitialized('fulfillments') && null !== $data->getFulfillments()) {
            $values_1 = [];
            foreach ($data->getFulfillments() as $value_1) {
                $values_1[] = $this->normalizer->normalize($value_1, 'json', $context);
            }
            $dataArray['fulfillments'] = $values_1;
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\BaseOrder::class => false];
    }
}
