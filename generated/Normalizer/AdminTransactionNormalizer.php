...
class AdminTransactionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminTransaction::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminTransaction::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminTransaction();
        ...
        if (\array_key_exists('transaction_group_id', $data) && $data['transaction_group_id'] !== null) {
            $object->setTransactionGroupId($data['transaction_group_id']);
            unset($data['transaction_group_id']);
        }
        elseif (\array_key_exists('transaction_group_id', $data) && $data['transaction_group_id'] === null) {
            $object->setTransactionGroupId(null);
        }
        ...
        if (\array_key_exists('account', $data) && $data['account'] !== null) {
            $object->setAccount($this->denormalizer->denormalize($data['account'], \Gracious\MedusaApiClientBundle\Model\AdminStoreCreditAccount::class, 'json', $context));
            unset($data['account']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['transaction_group_id'] = $data->getTransactionGroupId();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminTransaction::class => false];
    }
}
