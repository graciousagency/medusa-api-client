...
class StoreCartPromotionNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreCartPromotion::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreCartPromotion::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreCartPromotion();
        ...
        if (\array_key_exists('application_method', $data) && $data['application_method'] !== null) {
            $object->setApplicationMethod($this->denormalizer->denormalize($data['application_method'], \Gracious\MedusaApiClientBundle\Model\StoreCartPromotionApplicationMethod::class, 'json', $context));
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreCartPromotion::class => false];
    }
}