...
class StoreReturnNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreReturn::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreReturn::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreReturn();
        ...
        if (\array_key_exists('items', $data) && $data['items'] !== null) {
            ...
            foreach ($data['items'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreReturnItem::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreReturn::class => false];
    }
}
