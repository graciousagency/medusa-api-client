...
class BaseCartNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\BaseCart::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\BaseCart::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\BaseCart();
        ...
        if (\array_key_exists('region', $data) && $data['region'] !== null) {
            $object->setRegion($this->denormalizer->denormalize($data['region'], \Gracious\MedusaApiClientBundle\Model\BaseRegion::class, 'json', $context));
            unset($data['region']);
        }
        ...
        if (\array_key_exists('shipping_address', $data) && $data['shipping_address'] !== null) {
            ...
            $object->setShippingAddress($values);
        ...
        if (\array_key_exists('billing_address', $data) && $data['billing_address'] !== null) {
            ...
            foreach ($data['billing_address'] as $key_1 => $value_1) {
                $values_1[$key_1] = $value_1;
            }
            $object->setBillingAddress($values_1);
        ...
        if (\array_key_exists('shipping_methods', $data) && $data['shipping_methods'] !== null) {
            $values_4 = [];
            foreach ($data['shipping_methods'] as $value_4) {
                $values_4[] = $this->denormalizer->denormalize($value_4, \Gracious\MedusaApiClientBundle\Model\BaseCartShippingMethod::class, 'json', $context);
            }
            $object->setShippingMethods($values_4);
        ...
        if (\array_key_exists('payment_collection', $data) && $data['payment_collection'] !== null) {
            $object->setPaymentCollection($this->denormalizer->denormalize($data['payment_collection'], \Gracious\MedusaApiClientBundle\Model\BasePaymentCollection::class, 'json', $context));
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('shippingAddress') && null !== $data->getShippingAddress()) {
            $values = [];
            foreach ($data->getShippingAddress() as $key => $value) {
                $values[$key] = $value;
            }
            $dataArray['shipping_address'] = $values;
        }
        if ($data->isInitialized('billingAddress') && null !== $data->getBillingAddress()) {
            $values_1 = [];
            foreach ($data->getBillingAddress() as $key_1 => $value_1) {
                $values_1[$key_1] = $value_1;
            }
            $dataArray['billing_address'] = $values_1;
        }
        ...
        if ($data->isInitialized('shippingMethods') && null !== $data->getShippingMethods()) {
            $values_4 = [];
            foreach ($data->getShippingMethods() as $value_4) {
                $values_4[] = $this->normalizer->normalize($value_4, 'json', $context);
            }
            $dataArray['shipping_methods'] = $values_4;
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\BaseCart::class => false];
    }
}
