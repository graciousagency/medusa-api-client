...
class AdminTaxProvidersGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminTaxProvidersGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminTaxProvidersGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminTaxProvidersGetResponse200();
        ...
        if (\array_key_exists('tax_providers', $data) && $data['tax_providers'] !== null) {
            $values = [];
            foreach ($data['tax_providers'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminTaxProvider::class, 'json', $context);
            }
            $object->setTaxProviders($values);
            unset($data['tax_providers']);
        }
        elseif (\array_key_exists('tax_providers', $data) && $data['tax_providers'] === null) {
            $object->setTaxProviders(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getTaxProviders() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['tax_providers'] = $values;
        foreach ($data as $key => $value_1) {
            if (preg_match('/.*/', (string) $key)) {
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminTaxProvidersGetResponse200::class => false];
    }
}