...
class AdminDraftOrderListResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderListResponse::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderListResponse::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminDraftOrderListResponse();
        ...
        if (\array_key_exists('draft_orders', $data) && $data['draft_orders'] !== null) {
            $values = [];
            foreach ($data['draft_orders'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminDraftOrder::class, 'json', $context);
            }
            $object->setDraftOrders($values);
            unset($data['draft_orders']);
        }
        elseif (\array_key_exists('draft_orders', $data) && $data['draft_orders'] === null) {
            $object->setDraftOrders(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $values = [];
        foreach ($data->getDraftOrders() as $value) {
            $values[] = $this->normalizer->normalize($value, 'json', $context);
        }
        $dataArray['draft_orders'] = $values;
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminDraftOrderListResponse::class => false];
    }
}