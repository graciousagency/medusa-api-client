...
class AdminDraftOrdersPostBodyshippingAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrdersPostBodyshippingAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminDraftOrdersPostBodyshippingAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminDraftOrdersPostBodyshippingAddress();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminDraftOrdersPostBodyshippingAddress::class => false];
    }
}