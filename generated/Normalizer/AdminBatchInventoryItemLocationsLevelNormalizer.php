...
class AdminBatchInventoryItemLocationsLevelNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevel::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevel::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevel();
        ...
        if (\array_key_exists('create', $data) && $data['create'] !== null) {
            ...
            foreach ($data['create'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevelCreateItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('update', $data) && $data['update'] !== null) {
            ...
            foreach ($data['update'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevelUpdateItem::class, 'json', $context);
            }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminBatchInventoryItemLocationsLevel::class => false];
    }
}