...
class AdminGiftCardNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminGiftCard::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminGiftCard::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminGiftCard();
        ...
        if (\array_key_exists('line_item', $data) && $data['line_item'] !== null) {
            $object->setLineItem($this->denormalizer->denormalize($data['line_item'], \Gracious\MedusaApiClientBundle\Model\AdminOrderLineItem::class, 'json', $context));
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminGiftCard::class => false];
    }
}
