...
class StoreOrderLineItemDetailitemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitem();
        ...
        if (\array_key_exists('variant', $data) && $data['variant'] !== null) {
            $object->setVariant($this->denormalizer->denormalize($data['variant'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemVariant::class, 'json', $context));
            unset($data['variant']);
        }
        ...
        if (\array_key_exists('product', $data) && $data['product'] !== null) {
            $object->setProduct($this->denormalizer->denormalize($data['product'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemProduct::class, 'json', $context));
            unset($data['product']);
        }
        ...
        if (\array_key_exists('tax_lines', $data) && $data['tax_lines'] !== null) {
            ...
            foreach ($data['tax_lines'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemTaxLinesItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('adjustments', $data) && $data['adjustments'] !== null) {
            ...
            foreach ($data['adjustments'] as $value_1) {
                $values_1[] = $this->denormalizer->denormalize($value_1, \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemAdjustmentsItem::class, 'json', $context);
            }
        ...
        if (\array_key_exists('detail', $data) && $data['detail'] !== null) {
            $object->setDetail($this->denormalizer->denormalize($data['detail'], \Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitemDetail::class, 'json', $context));
            unset($data['detail']);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderLineItemDetailitem::class => false];
    }
}
