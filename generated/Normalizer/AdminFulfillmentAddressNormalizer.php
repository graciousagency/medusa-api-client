...
class AdminFulfillmentAddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentAddress::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentAddress::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminFulfillmentAddress();
        ...
        if (\array_key_exists('fulfillment_id', $data) && $data['fulfillment_id'] !== null) {
            $object->setFulfillmentId($data['fulfillment_id']);
            unset($data['fulfillment_id']);
        }
        elseif (\array_key_exists('fulfillment_id', $data) && $data['fulfillment_id'] === null) {
            $object->setFulfillmentId(null);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        $dataArray['fulfillment_id'] = $data->getFulfillmentId();
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminFulfillmentAddress::class => false];
    }
}
