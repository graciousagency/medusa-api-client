...
class StoreOrderShippingMethodTaxLinesItemNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItem::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItem::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItem();
        ...
        if (\array_key_exists('shipping_method', $data) && $data['shipping_method'] !== null) {
            $object->setShippingMethod($this->denormalizer->denormalize($data['shipping_method'], \Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItemshippingMethod::class, 'json', $context));
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\StoreOrderShippingMethodTaxLinesItem::class => false];
    }
}
