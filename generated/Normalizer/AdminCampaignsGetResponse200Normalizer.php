...
class AdminCampaignsGetResponse200Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminCampaignsGetResponse200::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminCampaignsGetResponse200::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminCampaignsGetResponse200();
        ...
        if (\array_key_exists('campaigns', $data) && $data['campaigns'] !== null) {
            $values = [];
            foreach ($data['campaigns'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, \Gracious\MedusaApiClientBundle\Model\CampaignResponse::class, 'json', $context);
            }
            $object->setCampaigns($values);
            unset($data['campaigns']);
        }
        elseif (\array_key_exists('campaigns', $data) && $data['campaigns'] === null) {
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminCampaignsGetResponse200::class => false];
    }
}