...
class AdminProductOptionValueNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Gracious\MedusaApiClientBundle\Model\AdminProductOptionValue::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Gracious\MedusaApiClientBundle\Model\AdminProductOptionValue::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        ...
        $object = new \Gracious\MedusaApiClientBundle\Model\AdminProductOptionValue();
        ...
        if (\array_key_exists('option', $data) && $data['option'] !== null) {
            $object->setOption($this->denormalizer->denormalize($data['option'], \Gracious\MedusaApiClientBundle\Model\AdminProductOption::class, 'json', $context));
            unset($data['option']);
        }
    ...
    public function normalize(mixed $data, ?string $format = null, array $context = []): array|string|int|float|bool|\ArrayObject|null
    {
        ...
        if ($data->isInitialized('option') && null !== $data->getOption()) {
            $dataArray['option'] = $this->normalizer->normalize($data->getOption(), 'json', $context);
        }
    ...
    {
        return [\Gracious\MedusaApiClientBundle\Model\AdminProductOptionValue::class => false];
    }
}
